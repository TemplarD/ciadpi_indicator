...
_STRINGS = {
    ...
    'engine.switch_hint': {'ru': 'Ползунок: слева byedpi (SOCKS-прокси), справа nfqws (перехват пакетов всех приложений)', 'en': 'Toggle: left byedpi (SOCKS proxy), right nfqws (packet interception for all apps)'},
    ...
    'engine.hint_state':  {'ru': 'Активен: {st}', 'en': 'Active: {st}'},
