...
_STRINGS = {
    ...
    'builder.automode_h': {'ru': 'Буквы s, o, n через запятую: s=кешировать, o=переподключать, n=не переподключать. Пусто = по умолчанию.',
                           'en': 'Letters s, o, n comma-separated: s=cache, o=reconnect, n=no reconnect. Blank = default.'},
