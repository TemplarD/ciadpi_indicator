...
${TARGET_USER} ALL=(root) NOPASSWD: ${NFT_BIN} -f /home/${TARGET_USER}/.config/ciadpi/ciadpi_bridge.nft
${TARGET_USER} ALL=(root) NOPASSWD: ${NFT_BIN} delete table inet ciadpi_bridge
EOF
fi
